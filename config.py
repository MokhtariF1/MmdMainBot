...
در صورتی که هر زمان مشکلی در اتصال داشتید با پشتیبانی هماهنگ باشید.""",
    ...
    "not_connected_pep": "هیچ دستگاهی به سرویس متصل نشده است!",
    "connected_pep": "لیست دستگاه های متصل شده به سرویس:👇",
    "convert_to_rep": "ارتقا به نماینده",
    "before_rep": "کاربر از قبل نماینده است",
    "success_rep": "کاربر با موفقیت به نماینده تبدیل شد&کد نماینده: {rep}"
}
